...
public class Admin_re_view extends JFrame implements Runnable {
...
//			getContentPane().add(p_member);
			...
			bt_postManage.setBounds(907, 82, 100, 30);
			...
			bt_cmtManage.setBounds(1021, 82, 100, 30);
	...
	public void history() {// 결제정보(수익정보, 결제내역) 패널
		...
		sp_pay = new JScrollPane(t_payHistory);
			sp_pay.setBounds(27, 128, 1178, 546);
