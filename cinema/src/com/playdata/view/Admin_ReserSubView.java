...
public class Admin_ReserSubView extends JPanel {
	...
	public Admin_ReserSubView() {
		...
		p_seat = new JPanel();
		p_seat.setBackground(new Color(242,240,229));
		...
		p_bt = new JPanel();
		p_bt.setBackground(new Color(242,240,229));
		p_center.add(p_bt);
		p_bt.setLayout(null);
